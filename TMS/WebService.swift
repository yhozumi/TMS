...
final class WebService {
  ...
  init(searchText: String, authToken: String) {
    ...
    self.searchUrl = "https://api.twitter.com/1.1/search/tweets.json?q=\(searchText.addingPercentEncoding(withAllowedCharacters: CharacterSet.alphanumerics)!)%20filter%3Atwimg&count=30&include_entities=true%22"
  }
